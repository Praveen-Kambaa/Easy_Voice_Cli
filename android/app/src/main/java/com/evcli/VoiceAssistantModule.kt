...
import com.evcli.FloatingMicService
import com.evcli.utils.PermissionUtils
import com.evcli.speech.SpeechRecognitionManager
...
class VoiceAssistantModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(reactContext) {
    ...
    fun injectText(text: String, promise: Promise) {
        mainScope.launch {
            try {
                ...
                val accessibilityIntent = Intent("com.evcli.VOICE_RESULT").apply {
    ...
    fun getInjectionMethods(promise: Promise) {
        try {
            ...
            val accessibilityIntent = Intent("com.evcli.VOICE_RESULT")
