...
public class MyAccessibilityService extends AccessibilityService {
    ...
    private static final String ACTION_VOICE_RESULT = "com.typeeasy.VOICE_RESULT";
    private static final String ACTION_RESET_INJECTION = "com.typeeasy.RESET_INJECTION";
    private static final String ACTION_SHOW_MIC = "com.typeeasy.SHOW_MIC";
    private static final String ACTION_HIDE_MIC = "com.typeeasy.HIDE_MIC";
